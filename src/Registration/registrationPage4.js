...
export const RegistrationPage4 = props => {
...
//will be pushed in order of render
    ...
    fields.push(new FieldModel('sparring', 'text', RenderField, 'Sparring'));
    fields.push(new FieldModel('traditionalForms', 'text', RenderField, 'Traditional Forms'));
    fields.push(new FieldModel('openForms', 'text', RenderField, 'Open Forms'));
    fields.push(new FieldModel('weaponsForms', 'text', RenderField, 'Weapons Forms'));
